- [Chapter 3 Java基本程序设计结构](#chapter-3-java基本程序设计结构)
  - [3.3 数据类型](#33-数据类型)
    - [3.3.1 整型](#331-整型)
    - [3.3.2 浮点类型](#332-浮点类型)
  ...
  - [3.5 运算符](#35-运算符)
    ...
    - [3.5.3 :moon:数值类型之间的转换](#353-moon数值类型之间的转换)
    - [3.5.4 :moon:强制类型转换 (Typecasting)](#354-moon强制类型转换-typecasting)
    - [3.5.5 结合赋值和运算符](#355-结合赋值和运算符)
    - [3.5.6 自增与自减运算符](#356-自增与自减运算符)
    - [3.5.7 关系与boolean运算符](#357-关系与boolean运算符)
    - [3.5.8 位运算符](#358-位运算符)
    - [3.5.9 括号与运算符级别](#359-括号与运算符级别)
  - [3.6 :full\_moon:字符串String](#36-full_moon字符串string)
    - [3.6.1 子串](#361-子串)
    - [3.6.2 拼接](#362-拼接)
    - [3.6.3 :full\_moon:不可变字符串](#363-full_moon不可变字符串)
    - [3.6.4 检测字符串是否相等](#364-检测字符串是否相等)
    - [3.6.5 空串与Null串](#365-空串与null串)
    - [3.6.6 码点与代码单元](#366-码点与代码单元)
    - [3.6.7 String API](#367-string-api)
    - [3.6.8 阅读联机API文档](#368-阅读联机api文档)
    - [9. 构建字符串](#9-构建字符串)
  - [3.7 :full\_moon:输入输出](#37-full_moon输入输出)
    - [3.7.1 读取输入](#371-读取输入)
    - [3.7.2 格式化输出(Formatted output)](#372-格式化输出formatted-output)
    - [3.7.3 文件输入与输出](#373-文件输入与输出)
    - [3.7.4 Command Line Input](#374-command-line-input)
  - [3.8 控制流程](#38-控制流程)
    - [3.8.1 块作用域](#381-块作用域)
    - [3.8.2 条件语句](#382-条件语句)
    - [3.8.3 循环](#383-循环)
    - [3.8.4 确定循环](#384-确定循环)
    - [3.8.5 多重选择: switch语句](#385-多重选择-switch语句)
    - [3.8.6 中断控制流程的语句](#386-中断控制流程的语句)
  - [3.10 数组Array](#310-数组array)
    - [3.10.1 :full\_moon:数组声明](#3101-full_moon数组声明)
      - [1. Base types](#1-base-types)
      - [2. access](#2-access)
      - [3. Three ways square brackets are used with an array name](#3-three-ways-square-brackets-are-used-with-an-array-name)
      - [4. An array is considered to be an object, not a class](#4-an-array-is-considered-to-be-an-object-not-a-class)
      - [5. Pitfall: An array of characters is not a String](#5-pitfall-an-array-of-characters-is-not-a-string)
      - [6. Methods that return arrays](#6-methods-that-return-arrays)
      - [7. 数组扩容](#7-数组扩容)
      - [8. Methods with a variable number of parameters](#8-methods-with-a-variable-number-of-parameters)
      - [9. :full\_moon:Privacy leaks with array](#9-full_moonprivacy-leaks-with-array)
      - [10. Array sorting](#10-array-sorting)
    - [3.10.2 访问数组元素](#3102-访问数组元素)
    - [3.10.3 for each loop](#3103-for-each-loop)
    - [3.10.4 数组拷贝](#3104-数组拷贝)
    - [3.10.5 命令行参数](#3105-命令行参数)
    - [3.10.6 数组排序](#3106-数组排序)
    - [3.10.7 多维数组](#3107-多维数组)
    - [3.10.8 不规则数组](#3108-不规则数组)
  - [3.11 :full\_moon:ArrayList](#311-full_moonarraylist)
    - [3.11.1 Using the ArrayList class](#3111-using-the-arraylist-class)
    - [3.11.2 常用API](#3112-常用api)
    - [3.11.3 More methods in the class ArrayList](#3113-more-methods-in-the-class-arraylist)
      - [3.11.3.1 Constructors](#31131-constructors)
      - [3.11.3.2 :star:Array-like methods](#31132-stararray-like-methods)
      - [3.11.3.3 Inserting elements](#31133-inserting-elements)
      - [3.11.3.4 Deleting elements](#31134-deleting-elements)
      - [3.11.3.5 Searching](#31135-searching)
      - [3.11.3.6 Finding the how many elements there are](#31136-finding-the-how-many-elements-there-are)
      - [3.11.3.7 Resizing the underlying array](#31137-resizing-the-underlying-array)
      - [3.11.3.8 Copies](#31138-copies)
    - [3.11.4 :star: Practice](#3114-star-practice)
  - [3.12 Enumerated types (枚举类型)](#312-enumerated-types-枚举类型)
    - [3.12.1 Basics of enumerated type](#3121-basics-of-enumerated-type)
    - [3.12.2 Enumerated type VS String](#3122-enumerated-type-vs-string)
    - [3.12.3 Enumerated Types in switch](#3123-enumerated-types-in-switch)
    - [3.12.4 Enumeration methods](#3124-enumeration-methods)
